...
public class dispatchPage {
    ...
    @FindBy(xpath = "//td[normalize-space()='TESTBED-STAGE']/preceding-sibling::td[1]/label[1]/span[1]/input[1]")
    static
    WebElement StageCheck;
    ...
    @FindBy(xpath = "//li[@class='ant-pagination-item ant-pagination-item-1']//a[@rel='nofollow'][normalize-space()='3']\n")
    static
