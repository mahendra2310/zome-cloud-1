  ...
  const sendLink = async (e) => {
    ...
    if (email === "") {
      ...
      setErrorMessage("Please include @ in your email.");
        ...
        await ApiPost('forgotUsername', data)
        .then(async (res: any) => {
          console.log(res,"res-----")
          if(res.status == 201){   
            setEmail("");
            ...
            <div className="lg:w-2/6 md:w-1/2 pl-8 pr-8 m-pl-2 m-login-banner">
              <div className="left">
                <div className="header welcome-text-align">
                  ...
                  <h6 className="child-text-color font-size-16 tracking-normal mt-3 mb-4">
                {message ? <p style={{ color: "green", fontWeight: "bold" }}>Your username has been sent to your</p> : ""}
...
export default ForgtoUsernameMain
